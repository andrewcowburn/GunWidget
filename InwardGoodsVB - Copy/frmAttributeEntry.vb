...
Public Class frmAttributeEntry
    ...
    <System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2100:Review SQL queries for security vulnerabilities")> Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
